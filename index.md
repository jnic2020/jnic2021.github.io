...
<h3><strong>Importante: </strong></h3> <h4>Para conectar a las jornadas vaya a la página del <a href="{{site.url}}/programa">programa</a> y allí encontrará los enlaces a las sesiones</h4>
